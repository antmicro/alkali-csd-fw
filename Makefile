...
$(BUILDROOT_TOOLCHAIN_TAR_FILE): | $(BUILDROOT_COMMON_OVERLAY_BUILD_DIR)
	$(MAKE) $(BUILDROOT_OPTS) $(BUILDROOT_DEFCONFIG_NAME)
...
$(BUILDROOT_OUTPUTS) &: $(APUAPP_OUTPUTS) $(RPUAPP_ZEPHYR_ELF) | $(BUILDROOT_BUILD_DIR) ## Build Buildroot
	...
	$(MAKE) -C $(BUILDROOT_BUILD_DIR) $(BUILDROOT_OPTS) $(BUILDROOT_DEFCONFIG_NAME)
	$(MAKE) -C $(BUILDROOT_BUILD_DIR) $(BUILDROOT_OPTS) -j`nproc`
