        ...
        TfLiteTensor* output_tensor)
{
    ...
    VTABufferCopy(input_1, 0, vtainput1, 0, sizeof(int8_t) * num, VTA_MEMCPY_H2D);
    VTABufferCopy(input_2, 0, vtainput2, 0, sizeof(int8_t) * num, VTA_MEMCPY_H2D);
    ...
    VTALoadBuffer2D(cmd, vtainput1, 0, num, 1, num, 0, 0, 0, 0, 0, VTA_MEM_ID_ACC_8BIT);
    VTALoadBuffer2D(cmd, vtainput2, 0, num, 1, num, 0, 0, 0, 0, num, VTA_MEM_ID_ACC_8BIT);
